...
// instructions
        ...
        iaload:
            ...
            0: begin phase_in = 1; `NPHASE; 
               a_in = t; aload = 1'b1; asel_in = 1'b1; end
            1: begin phase_in = 2; `NPHASE;
               a_in = a + 1; aload = 1'b1; asel_in = 1'b1;
        ...
        baload:
            case (phase)
            0: begin phase_in = 1; `SAMEOP;
               a_in = t; aload = 1'b1; asel_in = 1'b1;
               p_in = p - 1; end
            1: begin phase_in = 2;
        ...
        istore_0: begin
            r_in = t; rload = 1'b1;
            t_in = s; tload = 1'b1; spop = 1'b1; end
        iastore:
            case (phase)
            0: begin phase_in = 1; `NPHASE;
               a_in = s; aload = 1'b1; asel_in = 1'b1; spop = 1'b1;
        ...
        sastore:
            case (phase)
            0: begin phase_in = 1; `NPHASE;
               a_in = s; aload = 1'b1; asel_in = 1'b1; spop = 1'b1; end
            1: begin phase_in = 2; `NPHASE;
               a_in = a + 1; aload = 1'b1; asel_in = 1'b1;
               dselload = 1'b1; dsel_in = 2; write = 1'b1; end
            ...
            endcase
        pop: begin t_in = s; tload = 1'b1; spop = 1'b1; end
        pop2: begin
            case (phase)
            0: begin phase_in = 1; `NPHASE;
               t_in = s; tload = 1'b1; spop = 1'b1; end
        ...
        // ALU ops
        //
        iadd: begin t_in = s + t;            tload = 1'b1; spop = 1'b1; end
        isub: begin t_in = s - t;            tload = 1'b1; spop = 1'b1; end
        imul: begin t_in = product[DSZ-1:0]; tload = 1'b1; spop = 1'b1; end
        idiv: begin t_in = quotient;         tload = 1'b1; spop = 1'b1; end
        irem: begin t_in = remain;           tload = 1'b1; spop = 1'b1; end
        ineg: begin t_in = 0 - t;            tload = 1'b1; spop = 1'b1; end
        ishl: begin t_in = isht_o;           tload = 1'b1; spop = 1'b1; end
        ishr: begin t_in = isht_o;           tload = 1'b1; spop = 1'b1; shr_f = 1'b1; end
        iushr:begin t_in = iushr_o;          tload = 1'b1; spop = 1'b1; end
        iand: begin t_in = s & t;            tload = 1'b1; spop = 1'b1; end
        ior:  begin t_in = s | t;            tload = 1'b1; spop = 1'b1; end
        ixor: begin t_in = s ^ t;            tload = 1'b1; spop = 1'b1; end
        iinc:
            case (phase)
            0: begin phase_in = 1;
                    a_in = s; aload = 1'b1; aselload = 1'b1; asel_in = 1'b1; end
        ...
        jsr:
            case (phase)
            0: begin phase_in = 1;
                    a_in = t;     aload = 1'b1; aselload = 1'b1; asel_in = 1'b1; end
            1: begin phase_in = 2; `HOLDP;
                    a_in = a + 1; aload = 1'b1; aselload = 1'b1; asel_in = 1'b1;
                    t_in = data_i; tload = 1'b1; end
            default: begin phase_in = 0;
                    p_in = {t[23:0], data_i};
        ...
        ldi:
            ...
            endcase
        popr: begin
            t_in = r; tload = 1'b1; spush = 1'b1; rpop = 1'b1; end
        pushr: begin
            t_in = s; tload = 1'b1; spop = 1'b1;
        ...
        get:
            case (phase)
            0: begin phase_in = 1; `NPHASE;
                    a_in = iptr; aload = 1'b1; asel_in = 1'b1;
                    spush = 1'b1; end
            default: begin phase_in = 0; code_in = nop; `HOLDP;
                      t_in = data_i; tload = 1'b1;
                    iload = 1'b1; end
        ...
        put:
            case (phase)
            0: begin phase_in = 1; `NPHASE;
                    a_in = optr; aload = 1'b1; asel_in = 1'b1;
